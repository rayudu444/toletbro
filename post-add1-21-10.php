                   ...
                   <div class="container-post1">
                               ...
                               <div class="box-filters">
                                  <input class="Bedrooms " type="button" value="0"/>
                                    <input class="Bedrooms required <?php echo @ ($get_info['bedrooms']==1)?"active1":""?>" type="button" value="1"/>
                                  ...
                                  <div class="clearfix"></div>
								  <input type="hidden"  name="no_bedroos" id="no_bedroos" value="<?php echo @ $get_info['bedrooms']?>" />
                               </div>
                   </div>
                    <div class="clearfix"></div>
                </div>
                  ...
                  <div class="row mob-row">
                   ...
                   <div class="container-post1">
                               ...
                               <div class="box-filters ">
                                  ...
                                  <div class="clearfix"></div>
								  <input type="hidden"  name="no_bathrooms" id="no_bathrooms" value="<?php echo @ $get_info['bathrooms']?>" />
                               </div>
                   </div>
                    <div class="clearfix"></div>
                </div>
                  ...
                  <div class="row mob-row">
                   ...
                   <div class="container-post1">
                               ...
                               <div class="box-filters ">
								  ...
								  <input type="hidden" name="no_balconies"  id="no_balconies" value="<?php echo @ $get_info['balconies']?>" />
                  <div class="clearfix"></div>
                               </div>
                   </div>
                ...
                <div class="row mob-row">
                   ...
                   <div class="container-post1">
                               ...
                               <div class="box-filters ">
                                  ...
                                  <div class="clearfix"></div>
								  <input type="hidden" name="no_parking2" id="no_parking2" value="<?php echo @ $get_info['parking_2wheeler']?>" />
                               </div>
                   </div>
                                <div class="div-pad3">
                                  <p>4 Wheeler</p>
                   ...
                   <div class="container-post1">
                               ...
                               <div class="box-filters ">
                                  ...
                                  <div class="clearfix"></div>
								  <input type="hidden" name="no_parking4" id="no_parking4" value="<?php echo @ $get_info['parking_4wheeler']?>" />
                               </div>
                   </div>
                    <div class="clearfix"></div>
                </div>
