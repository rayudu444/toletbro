...
extract($_POST);
$count = get_row_count_by_condition('convention_users','where user_email="'.$user_email.'"');
if($count >0)
{
$user_info = get_row_count_by_condition('convention_users','where user_email="'.$user_email.'"');
//define the subject of the email
$subject = 'Forgot password Reset Link'; 
//define the message to be sent. Each line should be separated with \n
$link =URI."/creset-password.php?userinfo=".base64_encode($user_info['cnv_upid']);
