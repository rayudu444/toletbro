        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(data.status == "true" )
                {
                  ...
                  /* saveDataToLocal('user_id',data.user_details.id);
                   saveDataToLocal('email',data.user_details.email);
                   saveDataToLocal('first_name',data.user_details.first_name);
                   saveDataToLocal('Authorization',data.user_details.Authorization);*/
                   
                  window.location = 'http://localhost/toletbro/postanadd.php';
                }else{
...
$google_redirect_url 	= 'http://localhost/toletbro/index125.php'; //path to your script
...
$db_name = 'toletbro'; //Database Name
###################################################################
...
{
	echo '<a class="login" href="'.$authUrl.'"><img src="images/gplus-login.png"/></a>';
} 
else // user logged in 
{
   /* connect to database using mysqli */
	...
	if($user_exist)
	{
	 ...
	 $mysqli->query("INSERT INTO users (google_id, user_name, user_email, google_link, google_picture_link) 
        	...
        	<div class="row margin-0">
                <div>
                    <div class="col-md-6 col-sm-12 margin-0">
                        <ul class="list2">
                            <li class="current"><a href="#">Post An Ad</a></li>
                            <li><a href="#">Rent</a></li>
                            <div class="clear"></div>
                        </ul>
                    </div>
