                	...
                	<div>
                        ...
                        <form class="form1" action="property-listview.php" method="get">
                        	<label>
								...
								<input type="text" id="autocomplete" name="search_input" required  placeholder="Search by locality or landmark or building"  style="width:60% !important;"/>
								<input type="hidden" name="lat" value=""  id="lat"/>
								<input type="hidden" name="lng" value=""  id="lng"/>
								<select class="rent-select" required name="type">
